...
class OAuthManager:
    ...
    def initialize_client(self) -> tuple[str, str] | None:
        """
    ...
    def get_client(self) -> OAuthClient | None:
    ...
    def verify_client(self, client_id: str, client_secret: str | None = None) -> bool:
        """
    ...
    def refresh_access_token(self, refresh_token: str) -> OAuthToken | None:
        """
    ...
    def create_state(self, redirect_uri: str | None = None) -> str:
        """
